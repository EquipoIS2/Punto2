class Todo3sController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @todo3.save
        ...
        format.json { render :show, status: :created, location: @todo3 }
      else
  ...
  def update
    respond_to do |format|
      if @todo3.update(todo3_params)
        ...
        format.json { render :show, status: :ok, location: @todo3 }
      else
  ...
  def destroy
    @todo3.destroy
    respond_to do |format|
      format.html { redirect_to todo3s_url, notice: 'Todo3 was successfully destroyed.' }
  ...
  private
    ...
    def todo3_params
      params.require(:todo3).permit(:title, :content)
    end
end
